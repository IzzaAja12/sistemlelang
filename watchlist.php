...
<div class="max-w-7xl mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Pantauan Saya</h1>
    ...
    if (db_num_rows($watchlist_result) == 0) {
        echo '<div class="bg-blue-50 border border-blue-200 text-blue-800 rounded-lg p-6 text-center">
                <p class="text-lg mb-2">Daftar pantauan Anda kosong</p>
                <p class="text-sm">Telusuri daftar untuk menambahkan item ke daftar pantauan Anda</p>
                <a href="browse.php" class="inline-block mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">Telusuri Daftar</a>
              </div>';
    } else {
    ?>
